/* Here is my solution for the problem at the end of Chapter 8: create two
   side-by-side windows where text written in one is displayed with the
   rot13 cypher in the second.
   Remember to press ~ to end input.
   This is not "the" solution, nor is it most likely the best. */
